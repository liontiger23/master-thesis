...
\tikzset{node/.style={minimum width=2em, minimum height=2em,draw,font=\ttfamily}}
\tikzset{class/.style={node,rectangle}}
\tikzset{interface/.style={node,circle}}

\def\structnodewidth{4.5em}
\def\structnodeheight{4.5ex}
...
\tikzset{head/.style={struct base,font=\ttfamily\bfseries,fill=gray!20}}
\tikzset{field/.style={struct base,font=\ttfamily}}
...
\newcommand{\imtR}[3]{
    \draw [decorate,decoration={brace,amplitude=0.5em}] (#1.north east) -- (#2.south east) node [midway,font=\small\ttfamily\bfseries,right=0.25em] {#3};
}

\newcommand{\imtL}[3]{
    \draw [decorate,decoration={brace,amplitude=0.5em,mirror}] (#1.north west) -- (#2.south west) node [midway,font=\small\ttfamily\bfseries,left=0.25em] {#3};
}
